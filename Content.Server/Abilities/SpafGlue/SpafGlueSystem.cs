...
using Content.Shared.Abilities.SpafGlue; //my
...
public sealed class SpafGlueSystem : SharedSpafGlueSystem // Creating a system for the operation of the button
{
    ...
    {
        base.Initialize();
        SubscribeLocalEvent<SpafGlueComponent, SpafGlueEvent>(OnSpafGlue);
    }


    public float hunger_p = 0.0f; //Creating a field for transmitting information to another system. This will be needed later

    private void OnSpafGlue(EntityUid uid, SpafGlueComponent component, SpafGlueEvent args) // creating an action to turn a person into a man
    {

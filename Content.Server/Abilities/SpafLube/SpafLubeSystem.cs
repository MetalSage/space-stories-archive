...
using Content.Shared.Abilities.SpafLube; //my
...
public sealed class SpafLubeSystem : SharedSpafLubeSystem // Creating a system for the operation of the button
{
    ...
    {
        base.Initialize();
        SubscribeLocalEvent<SpafLubeComponent, SpafLubeEvent>(OnSpafLube);
    }


    public float hunger_p = 0.0f; //Creating a field for transmitting information to another system. This will be needed later

    private void OnSpafLube(EntityUid uid, SpafLubeComponent component, SpafLubeEvent args) // creating an action to turn a person into a man
    {

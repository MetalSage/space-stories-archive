...
using Content.Shared.Abilities.SpafEgg; //my
...
public sealed class SpafEggSystem : SharedSpafEggSystem // Creating a system for the operation of the button
{
    ...
    {
        base.Initialize();
        SubscribeLocalEvent<SpafEggComponent, SpafEggEvent>(OnSpafEgg);
    }


    public float hunger_p = 0.0f; //Creating a field for transmitting information to another system. This will be needed later

    private void OnSpafEgg(EntityUid uid, SpafEggComponent component, SpafEggEvent args) // creating an action to turn a person into a man
    {

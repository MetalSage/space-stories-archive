...
using Content.Shared.Abilities.SpafEvols; //my
...
public sealed class SpafEvolsSystem : SharedSpafEvolsSystem // Creating a system for the operation of the button
{
    ...
    {
        base.Initialize();
        SubscribeLocalEvent<SpafEvolsComponent, SpafEvolsEvent>(OnSpafEvols);
    }


    public float hunger_p = 0.0f; //Creating a field for transmitting information to another system. This will be needed later

    private void OnSpafEvols(EntityUid uid, SpafEvolsComponent component, SpafEvolsEvent args) // creating an action to turn a person into a man
    {

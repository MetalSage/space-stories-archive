...
using Content.Shared.Abilities.SpafStealth; //my
...
public sealed class SpafStealthSystem : SharedSpafStealthSystem // Creating a system for the operation of the button
{
    ...
    {
        base.Initialize();
        SubscribeLocalEvent<SpafStealthComponent, SpafStealthEvent>(OnSpafStealth);
    }


    public float hunger_p = 0.0f; //Creating a field for transmitting information to another system. This will be needed later

    private void OnSpafStealth(EntityUid uid, SpafStealthComponent component, SpafStealthEvent args) // creating an action to turn a person into a man
    {

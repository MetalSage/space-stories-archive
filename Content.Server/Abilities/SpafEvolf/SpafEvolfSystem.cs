...
using Content.Shared.Abilities.SpafEvolf; //my
...
public sealed class SpafEvolfSystem : SharedSpafEvolfSystem // Creating a system for the operation of the button
{
    ...
    {
        base.Initialize();
        SubscribeLocalEvent<SpafEvolfComponent, SpafEvolfEvent>(OnSpafEvolf);
    }


    public float hunger_p = 0.0f; //Creating a field for transmitting information to another system. This will be needed later

    private void OnSpafEvolf(EntityUid uid, SpafEvolfComponent component, SpafEvolfEvent args) // creating an action to turn a person into a man
    {
        ...
        if (_mindSystem.TryGetMind(uid, out var mindId, out var mind))
        {
            ...
            _metaData.SetEntityName(child, "Baby Slime"); // we give a new name to a new body. In this case, we give the name 'werewolf' to hide the identity of the turned
        }
    }
}

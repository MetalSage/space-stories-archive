...
shadowling-role-greeting =
    Вы - тенеморф.
    Вы должны поработить станцию, превознестись и стать богом
    Для этой несчастной станции. Вы можете подчинять волю членов экипажа
    При помощи своих способностей, но помните, что щит разума может
    Заблокировать вашу атаку.
shadowling-briefing =
    Используйте способность "Поработить" для подчинения членов экипажа
    И способность "Разум улья" для разблокировки новых способностей.
    Получите 15 рабов, чтобы получить возможность превознестись.

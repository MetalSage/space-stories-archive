...
namespace Content.Shared.SpafDevour.Components;

[RegisterComponent, NetworkedComponent]
[Access(typeof(SharedSpafDevourSystem))]
public sealed partial class SpafDevourerComponent : Component
{
    [DataField("SpafdevourAction", customTypeSerializer: typeof(PrototypeIdSerializer<EntityPrototype>))]
    public string? SpafDevourAction = "ActionSpafDevour";

    [DataField("SpafdevourActionEntity")]
    public EntityUid? SpafDevourActionEntity;
    ...
    [DataField("SpafdevourTime")]
    public float SpafDevourTime = 3f;

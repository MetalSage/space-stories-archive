...
/// </summary>
[UsedImplicitly]
public sealed class ConsoleLockSystem : EntitySystem
{
    ...
    public override void Initialize()
    {
        ...
        SubscribeLocalEvent<ConsoleLockComponent, ExaminedEvent>(OnExamined);
        SubscribeLocalEvent<ConsoleLockComponent, GetVerbsEvent<AlternativeVerb>>(AddToggleLockVerb);
    ...
    public bool TryLock(EntityUid uid, EntityUid user, ConsoleLockComponent? lockComp = null)
    {
    ...
    /// <param name="lockComp"></param>
    public void Unlock(EntityUid uid, EntityUid? user, ConsoleLockComponent? lockComp = null)
    {
        if (!Resolve(uid, ref lockComp))
            return;
        ...
        var ev = new ConsoleLockToggledEvent(false);
        RaiseLocalEvent(uid, ref ev, true);
    }
    ...
    public bool CanToggleLock(EntityUid uid, EntityUid user, bool quiet = true)
    {
        ...
        var ev = new ConsoleLockToggleAttemptEvent(user, quiet);
        RaiseLocalEvent(uid, ref ev, true);
        return !ev.Cancelled;
    }
    ...
    private void AddToggleLockVerb(EntityUid uid, ConsoleLockComponent component, GetVerbsEvent<AlternativeVerb> args)
    {
    ...
    private void OnEmagged(EntityUid uid, ConsoleLockComponent component, ref GotEmaggedEvent args)
    {
